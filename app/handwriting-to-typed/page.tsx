...
import { ArrowLeft, Download, Share2, Languages, FileImage, Save, Camera, Upload } from "lucide-react"
    ...
    <div className="container py-6 max-w-6xl">
      <header className="mb-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold font-playfair text-wood">Handwriting to typed</h1>
        </div>
      </header>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="lg:w-1/3 space-y-4">
          <div className="cabinet text-cream">
            <h2 className="text-xl font-semibold font-playfair mb-4">Your image:</h2>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button variant="outline" className="w-full border-cream/20 text-cream hover:bg-wood/80">
                Take picture
              </Button>
              <Button variant="outline" className="w-full border-cream/20 text-cream hover:bg-wood/80">
                Send image(s) again
          ...
          <div className="flex flex-col gap-2">
            <Button variant="outline" className="justify-start gap-2 border-wood text-wood hover:bg-wood/10">
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="lg:w-2/3 space-y-4">
          <div className="notebook-page rounded-lg p-4 border border-wood/20 relative">
            ...
            <div className="mb-4 pl-6">
              ...
              <p className="text-wood/70">You can edit by typing or re-send an image to be read again!</p>
            </div>
